...
namespace MMR.Randomizer
{
    public class Builder
    {
        ...
        private void WriteEntrances()
        {
            ...
            ResourceUtils.ApplyHack(Resources.mods.fix_drown_timer);
            ResourceUtils.ApplyHack(Resources.mods.fix_skyboxes);
            ResourceUtils.ApplyHack(Resources.mods.fix_spring_lens_cave_spawn);
            ResourceUtils.ApplyHack(Resources.mods.fix_poisoned_woodfall_spawns);
            ResourceUtils.ApplyHack(Resources.mods.fix_song_of_soaring_exits); // todo maybe NOP all the code, instead of just the SH commands.
        ...
        private void WriteDungeons()
        {
            ...
            foreach (var entrance in entrances)
            {
                ...
                //EntranceSwapUtils.WriteNewEntrance(mainExit, mainSpawn); // TODO
                ...
                if (exits.Count > 1 && newSpawns.Count > 1)
                {
                    ...
                    //EntranceSwapUtils.WriteNewEntrance(pairExit, pairSpawn); // TODO
                }
            }
